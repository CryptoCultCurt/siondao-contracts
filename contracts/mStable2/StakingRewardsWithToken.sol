...
import "./PlatformTokenVendor.sol";
import "./InitializableRewardsDistributionRecipient.sol";
import "./interfaces/IStakingRewardsWithPlatformToken.sol";
import "./interfaces/ISavingsContractV3.sol";
...
/// @custom:oz-upgrades-unsafe-allow constructor
    ...
    function initialize(
        ...
        _grantRole(DEFAULT_ADMIN_ROLE, msg.sender);
         InitializableRewardsDistributionRecipient.initialize(_nexus, _rewardsDistributor);
       // StakingTokenWrapper(_stakingToken) InitializableRewardsDistributionRecipient(_nexus);
        StakingTokenWrapper.initialize(_nameArg, _symbolArg, _stakingToken);
    ...
    ) internal override(InitializableRewardsDistributionRecipient, StakingTokenWrapper, UUPSUpgradeable) onlyRole(DEFAULT_ADMIN_ROLE) {}
    ...
    ****************************************/
     ...
     */
    function getPlatformToken() external view override returns (IERC20Upgradeable) {
